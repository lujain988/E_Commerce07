async function fetchCategoryCount() {
    try {
        const response = await fetch('https://localhost:7222/api/Categories/CountAllCategory');
...
fetchCategoryCount();
    ...
    async function fetchProductCount() {
        try {
            const response = await fetch('https://localhost:7222/api/Product/CountOfAllProduct');
            const count = await response.json();
